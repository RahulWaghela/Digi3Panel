...
router.get("/templateMessage", async (req, res) => {
  try {
...
router.get("/getMobileNumbers", async (req, res) => {
  try {
...
router.get("/getLogindata", async (req, res) => {
  try {
...
//Group_management
router.get("/Group_management", async (req, res) => {
  try {
...
router.get("/createCampaigns", async (req, res) => {
  try {
    const showInSelectBox = await NumberModel.find({});
...
router.get("/sendCampaignMessage", async (req, res) => {
  try {
...
router.get("/campaignHistory", async (req, res) => {
  try {
    const campaignhistory = await campaignHistory.find({});
...
router.get("/detaildcampaignHistory", async (req, res) => {
  try {
    const showingcampaignHistory = await campaignHistory.find({});
...
//Templates
router.get("/viewAllTemplates", (req, res) => {
  try {
...
router.get("/viewAllreports", (req, res) => {
  try {
    res.render("reports");
  } catch (error) {
    res.status(500).send("internal server Error");
...
router.post('/sendtemplateMessages', upload.single('extractExcel'), async (req, res) => {
